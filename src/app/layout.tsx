...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.tangoinsight.co.kr"),
  title: {
  ...
  keywords: [
    "탱고인사이트", "Tangoinsight", "(주)탱고인사이트",
    "AI OCR", "고문헌 OCR", "한자 OCR", "문서 디지털화",
    "KPO", "지식 프로세스 아웃소싱",
    "MooN AI OCR", "AI 학습 OCR", "데이터 가공", "문서 데이터베이스 구축",
  ],
  authors: [{ name: "탱고인사이트", url: "https://www.tangoinsight.co.kr" }],
  creator: "탱고인사이트",
  openGraph: {
    ...
    type: "website",
    locale: "ko_KR",
    url: "https://www.tangoinsight.co.kr",
    siteName: "탱고인사이트",
  },
  twitter: {
...
const jsonLd = {
  ...
  "@type": "Organization",
  name: "탱고인사이트",
  alternateName: ["Tangoinsight", "(주)탱고인사이트"],
  url: "https://www.tangoinsight.co.kr",
  foundingDate: "2022",
  description: "AI 학습 기반 Data-Adaptive OCR 기술과 KPO 서비스로 기업의 문서 디지털화를 지원하는 전문 기업",
  address: {
    "@type": "PostalAddress",
    addressCountry: "KR",
  },
  sameAs: ["https://www.tangoinsight.co.kr"],
};
